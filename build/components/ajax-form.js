...
var AjaxForm = /** @class */ (function (_super) {
    __extends(AjaxForm, _super);
    function AjaxForm() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AjaxForm.prototype.getContext = function () {
        return {
            window: window,
            $: $,
    ...
    AjaxForm.prototype.submit = function (event) {
        ...
        var data = Querystring.parse(this.element.serialize());
    ...
    AjaxForm.prototype.onSuccess = function (response, status, xhr) {
    ...
    AjaxForm.prototype.onError = function (xhr, status, error) {
